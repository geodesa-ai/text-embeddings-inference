...
fn test_mpnet() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("mpnet_batch", embeddings_batch, &matcher);
    ...
    insta::assert_yaml_snapshot!("mpnet_single", embeddings_single, &matcher);
...
fn test_mpnet_pooled_raw() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("mpnet_batch_pooled", pooled_embeddings_batch, &matcher);

    let raw_embeddings_batch = SnapshotEmbeddings::from(raw_embeddings);
    insta::assert_yaml_snapshot!("mpnet_batch_raw", raw_embeddings_batch, &matcher);
    ...
    let (pooled_embeddings, _) = sort_embeddings(backend.embed(input_single)?);
    let embeddings_single = SnapshotEmbeddings::from(pooled_embeddings);
    insta::assert_yaml_snapshot!("mpnet_single_pooled", embeddings_single, &matcher);
    ...
    insta::assert_yaml_snapshot!("mpnet_single_raw", embeddings_single, &matcher);
