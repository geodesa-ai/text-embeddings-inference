...
fn test_alibaba_gte() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("alibaba_gte_batch", embeddings_batch, &matcher);
    ...
    insta::assert_yaml_snapshot!("alibaba_gte_single", embeddings_single, &matcher);
...
fn test_snowflake_gte() -> Result<()> {
    ...
    let (pooled_embeddings, _) = sort_embeddings(backend.embed(input_batch)?);
    let embeddings_batch = SnapshotEmbeddings::from(pooled_embeddings);
    insta::assert_yaml_snapshot!("snowflake_gte_batch", embeddings_batch, &matcher);
