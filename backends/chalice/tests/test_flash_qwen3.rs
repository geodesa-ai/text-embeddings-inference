...
fn test_flash_qwen3() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("qwen3_batch", embeddings_batch, &matcher);
    ...
    insta::assert_yaml_snapshot!("qwen3_single", embeddings_single, &matcher);
